...
<head>
    ...
    <title>Clientes | Chilacajita</title>
</head>
<body>
    <header>
    ...
    <main class="container mt-4 mb-2">
      <div class="row align-items-center">
        ...
        <div class="col-auto">
          <a class="btn btn-warning" href="/scm-chilacajita/create-cliente.php" role="button">Nuevo Cliente</a>
            ...
            <tbody>
              ...
              while($row = $result->fetch_assoc()) {
                ...
                <tr>
                  ...
                  <td>$row[telefono]</td>
                  <td>
                    <a class='btn btn-warning btn-sm' href='/scm-chilacajita/edit-cliente.php?id_Cliente=$row[id_Cliente]'>Editar</a>
                    <a class='btn btn-danger btn-sm' href='/scm-chilacajita/delete-cliente.php?id_Cliente=$row[id_Cliente]'>Borrar</a>
                  </td>
                </tr>
                ";
              }
