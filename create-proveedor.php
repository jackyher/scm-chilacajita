...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    do {
        ...
        //Añadir nuevo proveedor a la base de datos
        ...
        $successMessage = "Proveedor añadido correctamente";
...
<head>
    ...
    <title>Crear Proveedor | Chilacajita</title>
</head>
<body>
    <header>
    ...
    <main class="container mt-4 mb-2">
        <p class="fs-3 fw-bold">Nuevo Proveedor</p>
    </main>
