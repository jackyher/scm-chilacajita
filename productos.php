...
<head>
    ...
    <title>Productos | Chilacajita</title>
</head>
<body>
    <header>
    ...
    <main class="container mt-4 mb-2">
      <div class="row align-items-center">
        <div class="col">
          <h1 class="fs-3 fw-bold">Productos</h1>
        </div>
        <div class="col-auto">
          <a class="btn btn-warning" href="/scm-chilacajita/create-producto.php" role="button">Nuevo Producto</a>
            ...
            <tbody>
              ...
              while($row = $result->fetch_assoc()) {
                ...
                <tr>
                  ...
                  <td>
                    <a class='btn btn-warning btn-sm' href='/scm-chilacajita/edit-producto.php?id_Producto=$row[id_Producto]'>Editar</a>
                    <a class='btn btn-danger btn-sm' href='/scm-chilacajita/delete.php?id_Producto=$row[id_Producto]'>Borrar</a>
                  </td>
                </tr>
                ";
              }
