...
<head>
    ...
    <title>Ventas | Chilacajita</title>
</head>
<body>
    <header>
    ...
    <main class="container mt-4 mb-2">
      <div class="row align-items-center">
        <div class="col">
          <h1 class="fs-3 fw-bold">Ventas</h1>
        </div>
        <div class="col-auto">
          <a class="btn btn-warning" href="/scm-chilacajita/create-venta.php" role="button">Nueva Venta</a>
            ...
            <tbody>
              ...
              while($row = $result->fetch_assoc()) {
                ...
                <tr>
                  ...
                  <td>$row[cantidad]</td>
                  <td>$row[precio_unitario_venta]</td>
