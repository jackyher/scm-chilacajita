...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    // Para mostrar los datos de clientes
    ...
    $sql = "SELECT * FROM ctg_cliente WHERE id_Cliente=$id_Cliente";
    ...
    do {
        if(empty($id_Cliente) || empty($nombre) || empty($contacto) || empty($direccion) || empty($telefono)) {
            $errorMessage = "Todos los campos son requeridos";
            break;
        }

        $sql = "UPDATE ctg_cliente " .
...
<head>
    ...
    <title>Editar Cliente | Chilacajita</title>
</head>
<body>
    <header>
    ...
    <main class="container mt-4 mb-2">
        <p class="fs-3 fw-bold">Editar Cliente</p>
    </main>
